...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/dt0ysb7m/settings/api) and create a token with read rights.
